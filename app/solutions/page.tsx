          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            <Card className="bg-[#5B0202]/10 backdrop-blur-md border-[#8B0000]/20 hover:border-[#8B0000] transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#a83232]">Lead Qualification AI</CardTitle>
                <CardDescription className="text-[#a83232]/70">
                  Automatically qualify and nurture leads 24/7
                </CardDescription>
              </CardHeader>
              <CardContent className="text-[#a83232]/80 space-y-3">
                <p>
            ...
            <Card className="bg-[#5B0202]/10 backdrop-blur-md border-[#8B0000]/20 hover:border-[#8B0000] transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#a83232]">Project Management AI</CardTitle>
                <CardDescription className="text-[#a83232]/70">
            ...
            <Card className="bg-[#5B0202]/10 backdrop-blur-md border-[#8B0000]/20 hover:border-[#8B0000] transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#a83232]">Client Communication AI</CardTitle>
                <CardDescription className="text-[#a83232]/70">
            ...
            <Card className="bg-[#5B0202]/10 backdrop-blur-md border-[#8B0000]/20 hover:border-[#8B0000] transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#a83232]">Cost Estimation AI</CardTitle>
                <CardDescription className="text-[#a83232]/70">Accurate quotes powered by market data</CardDescription>
              </CardHeader>
              <CardContent className="text-[#a83232]/80 space-y-3">
                <p>
            ...
            <Card className="bg-[#5B0202]/10 backdrop-blur-md border-[#8B0000]/20 hover:border-[#8B0000] transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#a83232]">Analytics & Insights AI</CardTitle>
                <CardDescription className="text-[#a83232]/70">Data-driven decisions for growth</CardDescription>
              </CardHeader>
              <CardContent className="text-[#a83232]/80 space-y-3">
                <p>
            ...
            <Card className="bg-[#5B0202]/10 backdrop-blur-md border-[#8B0000]/20 hover:border-[#8B0000] transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl text-[#a83232]">Vendor Management AI</CardTitle>
                <CardDescription className="text-[#a83232]/70">Streamlined supplier coordination</CardDescription>
              </CardHeader>
              <CardContent className="text-[#a83232]/80 space-y-3">
                <p>
          ...
          <div className="bg-[#5B0202]/10 backdrop-blur-md border border-[#8B0000]/20 rounded-3xl p-12 mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div className="p-6 bg-[#8B0000]/10 rounded-2xl">
                ...
                <div className="text-[#a83232] font-semibold">Email</div>
              </div>
              <div className="p-6 bg-[#8B0000]/10 rounded-2xl">
                <div className="text-4xl mb-3">💬</div>
                <div className="text-[#a83232] font-semibold">WhatsApp</div>
              </div>
              <div className="p-6 bg-[#8B0000]/10 rounded-2xl">
                <div className="text-4xl mb-3">📱</div>
                <div className="text-[#a83232] font-semibold">CRM Systems</div>
              </div>
              <div className="p-6 bg-[#8B0000]/10 rounded-2xl">
                <div className="text-4xl mb-3">📊</div>
                <div className="text-[#a83232] font-semibold">Project Tools</div>
              </div>
            </div>
          </div>
