      ...
      {!isDesktop ? (
        ...
        <div className="min-h-screen flex items-center justify-center px-6 py-20">
          <div className="max-w-md text-center">
            ...
            <h2 className="text-3xl font-bold mb-4 text-[#a83232]">Desktop Experience Required</h2>
            <p className="text-lg text-[#a83232]/80 mb-8 leading-relaxed">
            ...
            <div className="space-y-4">
              <Link href="/demo">
                <Button className="w-full px-7 py-6 text-lg bg-gradient-to-r from-[#C41E3A] to-[#8B1538] text-[#a83232] rounded-full font-semibold hover:scale-105 transition-all">
                  Book a Demo
                </Button>
              </Link>
              <Link href="/solutions">
                <Button
                  variant="outline"
                  className="w-full px-7 py-6 text-lg border-2 border-[#C41E3A] text-[#a83232] rounded-full font-semibold hover:bg-[#C41E3A]/10 transition-all bg-transparent"
                >
                  View Solutions
                </Button>
              </Link>
        ...
        <div ref={scrollContainerRef} className="relative h-[200vh]">
          ...
          >
            ...
            {spline1Loaded && (
              <>
                <h2 className="relative z-10 text-3xl font-bold text-[#a83232]/80 mt-auto mb-8 animate-pulse">
                  The Future of Building is Here
                </h2>
                <p className="relative z-10 text-[#a83232]/50 mb-8">Scroll Down to Begin</p>
              </>
            )}
          </div>
            ...
            <section className="h-full flex items-center px-[5%]">
              <div className="max-w-[1400px] mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
                <div className="z-10">
                  ...
                  <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-5 bg-gradient-to-r from-[#a83232] via-[#C41E3A] to-[#a83232] bg-clip-text text-transparent bg-[length:200%_auto] animate-[gradientShift_3s_linear_infinite] text-balance">
                    Custom AI Agents Built Specifically to Scale Your Business
                  </h1>
                  <p className="text-xl text-[#a83232]/80 mb-10 leading-relaxed">
                  ...
                  <div className="flex flex-col sm:flex-row gap-5">
                    <Link href="/demo">
                      <Button className="px-7 py-6 text-lg bg-gradient-to-r from-[#C41E3A] to-[#8B1538] text-[#a83232] rounded-full font-semibold hover:scale-105 hover:shadow-lg hover:shadow-[#C41E3A]/30 transition-all">
                        Start Your AI Journey
                      </Button>
                    </Link>
                    <a
                      href="#features"
                      className="px-7 py-3 bg-transparent text-[#a83232] border-2 border-[#C41E3A] rounded-full text-base font-semibold inline-flex items-center gap-2 hover:bg-[#C41E3A] transition-all"
                    >
                      Watch Demo
      ...
      <div className="relative z-10 bg-[#200E01]">
        ...
        <section id="features" className="py-20 md:py-32 px-[5%] bg-gradient-to-b from-[#200E01] to-[#1a0a01]">
          <div className="max-w-[1400px] mx-auto">
            <div className="text-center mb-12 md:mb-20">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-5 bg-gradient-to-r from-[#a83232] to-[#C41E3A] bg-clip-text text-transparent">
                Engineered for Excellence
              </h2>
              <p className="text-lg md:text-xl text-[#a83232]/70 max-w-2xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-10">
              <div className="p-6 md:p-10 bg-[#8B1538]/10 backdrop-blur-md border border-[#C41E3A]/20 rounded-3xl transition-all hover:-translate-y-3 hover:border-[#C41E3A] relative overflow-hidden group">
                ...
                <p className="text-[#a83232]/80 leading-relaxed">
        ...
        <section className="py-12 md:py-20 px-[5%] bg-[#C41E3A]/5 border-y border-[#C41E3A]/20">
          <div className="max-w-[1200px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 text-center">
            <div>
              <div className="text-5xl font-extrabold bg-gradient-to-r from-[#C41E3A] to-[#a83232] bg-clip-text text-transparent mb-3">
                87%
              </div>
              <div className="text-lg text-[#a83232]/80">Time Saved on Admin</div>
            </div>
            <div>
              <div className="text-5xl font-extrabold bg-gradient-to-r from-[#C41E3A] to-[#a83232] bg-clip-text text-transparent mb-3">
                3.5x
              </div>
              <div className="text-lg text-[#a83232]/80">Faster Client Response</div>
            </div>
            <div>
              <div className="text-5xl font-extrabold bg-gradient-to-r from-[#C41E3A] to-[#a83232] bg-clip-text text-transparent mb-3">
                R2.4M
              </div>
              <div className="text-lg text-[#a83232]/80">Average Cost Saved</div>
            </div>
            <div>
              <div className="text-5xl font-extrabold bg-gradient-to-r from-[#C41E3A] to-[#a83232] bg-clip-text text-transparent mb-3">
                24/7
              </div>
              <div className="text-lg text-[#a83232]/80">AI Availability</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 md:py-32 px-[5%] text-center bg-[radial-gradient(circle_at_center,rgba(196,30,58,0.1)_0%,transparent_70%)]">
          <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-5 bg-gradient-to-r from-[#a83232] to-[#C41E3A] bg-clip-text text-transparent">
              Ready to Transform Your Building Business?
            </h2>
            <p className="text-lg md:text-xl text-[#a83232]/80 mb-10">
            ...
            <Link href="/demo">
              <Button className="px-8 md:px-10 py-5 md:py-6 text-base md:text-lg bg-gradient-to-r from-[#C41E3A] to-[#8B1538] text-[#a83232] rounded-full font-semibold hover:scale-105 hover:shadow-lg hover:shadow-[#C41E3A]/30 transition-all">
