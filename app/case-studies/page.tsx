        ...
        <div className="max-w-[1400px] mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-10">
                  ...
                  <CardHeader className="p-0 mb-6">
                    <CardTitle className="text-3xl text-[#a83232] mb-3">
                      Luxury Homes Cape Town: 3x Lead Conversion
                    </CardTitle>
                    <CardDescription className="text-[#a83232]/70 text-lg">
                      How a boutique builder tripled their lead conversion rate with AI-powered qualification
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-0 space-y-4 text-[#a83232]/80">
                    ...
                    <div className="grid grid-cols-2 gap-4 py-6">
                      <div className="text-center p-4 bg-[#8B0000]/20 rounded-xl">
                        <div className="text-3xl font-bold text-[#a83232] mb-1">3x</div>
                        <div className="text-sm text-[#a83232]/70">Lead Conversion</div>
                      </div>
                      <div className="text-center p-4 bg-[#8B0000]/20 rounded-xl">
                        <div className="text-3xl font-bold text-[#a83232] mb-1">92%</div>
                        <div className="text-sm text-[#a83232]/70">Response Time Reduction</div>
                      </div>
                    </div>
                    <blockquote className="border-l-4 border-[#8B0000] pl-4 italic text-[#a83232]/90">
                    ...
                    <p className="text-sm text-[#a83232]/60">— Michael van der Merwe, Owner</p>
                  </CardContent>
                </div>
                <div className="bg-gradient-to-br from-[#8B0000]/20 to-[#5B0202]/10 flex items-center justify-center p-10">
                  <div className="text-center">
                    <div className="text-8xl mb-4">🏠</div>
                    <div className="text-2xl font-bold text-[#a83232]">R4.2M</div>
                    <div className="text-[#a83232]/70">Additional Revenue in 6 Months</div>
                  </div>
                </div>
              </div>
            </Card>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-[#8B0000]/20 to-[#5B0202]/10 flex items-center justify-center p-10 order-2 md:order-1">
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-[#a83232]">15 Hours</div>
                    <div className="text-[#a83232]/70">Saved Per Week</div>
                  </div>
                </div>
                <div className="p-10 order-1 md:order-2">
                  ...
                  <CardContent className="p-0 space-y-4 text-[#a83232]/80">
                    ...
                    <div className="grid grid-cols-2 gap-4 py-6">
                      <div className="text-center p-4 bg-[#8B0000]/20 rounded-xl">
                        <div className="text-3xl font-bold text-[#a83232] mb-1">87%</div>
                        <div className="text-sm text-[#a83232]/70">Less Admin Time</div>
                      </div>
                      <div className="text-center p-4 bg-[#8B0000]/20 rounded-xl">
                        <div className="text-3xl font-bold text-[#a83232] mb-1">100%</div>
                        <div className="text-sm text-[#a83232]/70">On-Time Delivery</div>
                      </div>
                    </div>
                    <blockquote className="border-l-4 border-[#8B0000] pl-4 italic text-[#a83232]/90">
                    ...
                    <p className="text-sm text-[#a83232]/60">— Sarah Naidoo, Project Director</p>
                  </CardContent>
                </div>
              </div>
            </Card>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-10">
                  ...
                  <CardContent className="p-0 space-y-4 text-[#a83232]/80">
                    ...
                    <div className="grid grid-cols-2 gap-4 py-6">
                      <div className="text-center p-4 bg-[#8B0000]/20 rounded-xl">
                        <div className="text-3xl font-bold text-[#a83232] mb-1">98%</div>
                        <div className="text-sm text-[#a83232]/70">Client Satisfaction</div>
                      </div>
                      <div className="text-center p-4 bg-[#8B0000]/20 rounded-xl">
                        <div className="text-3xl font-bold text-[#a83232] mb-1">5x</div>
                        <div className="text-sm text-[#a83232]/70">More Referrals</div>
                      </div>
                    </div>
                    <blockquote className="border-l-4 border-[#8B0000] pl-4 italic text-[#a83232]/90">
                    ...
                    <p className="text-sm text-[#a83232]/60">— David Pillay, Managing Director</p>
                  </CardContent>
                </div>
                <div className="bg-gradient-to-br from-[#8B0000]/20 to-[#5B0202]/10 flex items-center justify-center p-10">
                  <div className="text-center">
                    <div className="text-8xl mb-4">⭐</div>
                    <div className="text-2xl font-bold text-[#a83232]">4.9/5</div>
                    <div className="text-[#a83232]/70">Average Client Rating</div>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div className="bg-[#5B0202]/10 backdrop-blur-md border border-[#8B0000]/20 rounded-3xl p-12 mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-4xl font-bold text-[#a83232] mb-2">R12.8M</div>
                <div className="text-[#a83232]/70">Total Revenue Increase</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#a83232] mb-2">450+</div>
                <div className="text-[#a83232]/70">Hours Saved Monthly</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#a83232] mb-2">96%</div>
                <div className="text-[#a83232]/70">Client Satisfaction</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-[#a83232] mb-2">4.2x</div>
